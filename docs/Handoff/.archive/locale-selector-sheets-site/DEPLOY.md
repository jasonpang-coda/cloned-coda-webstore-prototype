...
2. Set **Root Directory** to `docs/Handoff/locale-selector-sheets` (Edit → enter path → Continue).
...
4. Deploy. Copy the production URL (e.g. `locale-selector-sheets-handoff.vercel.app`).
