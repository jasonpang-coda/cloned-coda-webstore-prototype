...
**Last updated:** June 2026 · v0.33.0 — Transaction History motion documented (`dropdown` transition, option-row stagger, card-entrance stagger; all reuse existing tokens)
